...
accepted, a maintainer may assist with the collaboration or open the
...
```shell
git remote add upstream https://github.com/vmware/packer-plugin-vmware.git
...
[gh-discussions-triage]: https://github.com/vmware/packer-plugin-vmware/discussions/new?category=triage
[gh-discussions-ideas]: https://github.com/vmware/packer-plugin-vmware/discussions/new?category=ideas
